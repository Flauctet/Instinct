...
//=============================================================================
 /*:
 * @plugindesc v 1.5 Fit width and height to the resolution of your screen. Select what folder of battleback have to use. Can force full screen. Can select screen width an height
 * @author Bodkaa
...
if(selectResType == 'Disabled'){SceneManager._screenWidth  = screen.width;
